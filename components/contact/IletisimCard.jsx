     ...
     <div className="border-t border-slate-100 pt-3">
      ...
      <div className="flex items-center gap-3">
       <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-pink-100 to-purple-100 text-pink-600 shadow-sm transition-all hover:scale-105 hover:shadow-md"
       ...
       <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="flex size-12 shrink-0 items-center justify-center rounded-lg bg-linear-to-br from-blue-100 to-blue-50 text-[#1877F2] shadow-sm transition-all hover:scale-105 hover:shadow-md"
        aria-label="Facebook"
       >
