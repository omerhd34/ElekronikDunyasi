 ...
 return (
  <div className="min-h-screen bg-gray-50/50">
   <div className="container px-4 py-8 md:py-12">
    <h1 className="mb-2 text-2xl font-bold text-gray-800 md:text-3xl">Favorilerim</h1>
    <p className="mb-8 text-gray-500">Beğendiğiniz ürünler burada listelenir.</p>
    {loading && favoriteIds.length > 0 ? (
     <div className="rounded-2xl bg-white py-12 text-center text-gray-500">Yükleniyor…</div>
    ) : products.length === 0 ? (
     <div className="flex flex-col items-center justify-center rounded-2xl bg-white py-20 shadow-sm">
      ...
      <h2 className="mb-2 text-xl font-semibold text-gray-800">Henüz favori ürününüz yok.</h2>
      <p className="mb-8 max-w-sm text-center text-gray-500">Ürün kartlarındaki kalp ikonuna tıklayarak beğendiğiniz ürünleri favorilere ekleyebilirsiniz.</p>
